...
\usepackage{braket, bbold, amssymb,amsthm,amsmath,mathtools, tikz-cd}
...
\begin{corollary} \label{corsubmanifold}
  ...
  is a diffeomorphism. %write that they are open sets?
\end{corollary}
...
\begin{example}[Projective space]
  ...
  Let's consider the atlas $\mathcal{A} = \{\phi_i \colon \mathbb{K} \rightarrow \mathbb{K} P^n \}$. Where
  \begin{align*}
    \phi_i \colon \mathbb{K} &\rightarrow \mathbb{K}P^n \\
    (x_1, \ldots, x_n) &\mapsto [x_1, \ldots, \underbrace{1}_{i-th}, \ldots, x_n]
  \end{align*}
